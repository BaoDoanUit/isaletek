<%@ Page Title="Forum" Language="C#" MasterPageFile="~/Layout.master"
    AutoEventWireup="true"
    CodeBehind="ForumCreate.aspx.cs" Inherits="WebApplication.Pages.ForumCreate" %>
    ...
    <script type="text/javascript">
        ...
        function FormEndCallback(s, e) {
            ...
            if (str[0] === 'UploadFile') {
                ...
                window.location = "/Pages/ForumCreate.aspx?Id=" + str[1];
            }
            else
                alert(s.cpAlert);
        }
        ...
        <div class="col-md-12">
            <dx:ASPxFormLayout runat="server" ID="ASPxFormLayout1" Width="100%" Height="100%">
                <Items>
                    ...
                    <dx:LayoutItem Caption="Tilte">
                        <LayoutItemNestedControlCollection>
                            <dx:LayoutItemNestedControlContainer>
                                <dx:ASPxButtonEdit runat="server" Width="100%"
                                    ID="txtTitle" ClientInstanceName="txtTitle">
                    ...
                    <dx:LayoutItem Caption="Content">
                        <LayoutItemNestedControlCollection>
                            <dx:LayoutItemNestedControlContainer>
                                <dx:ASPxHtmlEditor ID="editorContent" ClientInstanceName="editorContent" runat="server" Height="350px" Width="100%">
                                    <SettingsDialogs>
                                        <InsertImageDialog>
                                            <SettingsImageUpload UploadFolder="~/UploadFiles/Forum/Images/">
                                            </SettingsImageUpload>
                                        </InsertImageDialog>
                                    </SettingsDialogs>
                                </dx:ASPxHtmlEditor>
