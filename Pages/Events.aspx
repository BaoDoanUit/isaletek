<%@ Page Title="Events" Language="C#" MasterPageFile="~/Layout.master"
    ...
    CodeBehind="Events.aspx.cs" Inherits="WebApplication.Pages.Events" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="Content" runat="server">
    ...
    <script type="text/javascript">
        ...
        function New() {
            window.location = "/Pages/EventsCreate.aspx?Id=0";
        }

        function Edit(Id) {
            window.location = "/Pages/EventsCreate.aspx?Id=" + Id;
        }
                        ...
                        <PanelCollection>
                            <dx:PanelContent runat="server">
                                <dx:ASPxGridView runat="server" AutoGenerateColumns="False"
                                    ID="gvEvents"
                                    ClientInstanceName="gvEvents" Width="100%"
                                    ...
                                    <Columns>
                                        ...
                                        <dx:GridViewDataColumn VisibleIndex="8" Caption="" Width="190px">
                                            ...
                                            <CellStyle HorizontalAlign="Center"></CellStyle>
                                            <DataItemTemplate>
                                                <a onclick='<%# "EditSlide(" +Eval("Id") +")" %>' style="padding: 0 10px; cursor: pointer">Edit Slide</a>
                                ...
                                <asp:ObjectDataSource runat="server" ID="odsNews"
                                    ...
                                    <SelectParameters>
                                        ...
                                        <asp:Parameter Name="ArticleType" DefaultValue="Events" />
                                    </SelectParameters>
