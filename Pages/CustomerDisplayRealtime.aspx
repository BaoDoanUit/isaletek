<%@ Page Title="Display Realtime" Language="C#" MasterPageFile="~/Layout.master" AutoEventWireup="true" CodeBehind="CustomerDisplayRealtime.aspx.cs" Inherits="WebApplication.Pages.CustomerDisplayRealtime" %>
    ...
    <div class="row filter">
        <div class="col-md-4">
            <fieldset class="scheduler-border ">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <dx:ASPxDateEdit runat="server" Width="100%" OnInit="txtDate_Init" Caption="Date *" ID="txtDate" ClientInstanceName="fToDate" DisplayFormatString="MMM dd"
                ...
                <div class="row marginTop10">
                    <div class="col-md-12">
                        <dx:ASPxRadioButtonList runat="server" Width="100%" Caption="Product *" ID="rdProduct" RepeatColumns="2" DataSourceID="odsProduct" ValueField="Product" dis TextField="Product" RepeatDirection="Vertical">
        ...
        <div class="col-md-4" style="padding-top: 28px">
            <dx:ASPxGridView ID="grDisplayWeek" runat="server" AutoGenerateColumns="false" Theme="Material" Width="320">
                <Columns>
                </Columns>
                <Settings VerticalScrollBarStyle="Standard" VerticalScrollableHeight="220" VerticalScrollBarMode="Visible" />
        ...
        <PanelCollection>
            <dx:PanelContent runat="server">
                <dx:ASPxGridView ID="grData" runat="server" AutoGenerateColumns="false" Theme="Material" OnLoad="grData_Load" Width="1140px">
                    ...
                    <Settings HorizontalScrollBarMode="Visible" VerticalScrollableHeight="350" VerticalScrollBarMode="Visible" />
                    <SettingsBehavior AllowSort="true" ColumnResizeMode="Control" />
                    <Styles>
                        <Header HorizontalAlign="Center" Wrap="True" Paddings-Padding="3px"></Header>
                        <Cell Wrap="True" VerticalAlign="Middle" Paddings-Padding="5px"></Cell>
