...
<%@ Page Title="Forum" Language="C#" MasterPageFile="~/Layout.master"
    ...
    CodeBehind="Forum.aspx.cs" Inherits="WebApplication.Pages.Forum" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="Content" runat="server">
    ...
    <script type="text/javascript">
        ...
        function New() {
            window.location = "/Pages/ForumCreate.aspx?Id=0";
        }

        function Edit(Id) {
            window.location = "/Pages/ForumCreate.aspx?Id=" + Id;
        }
                        ...
                        <PanelCollection>
                            <dx:PanelContent runat="server">
                                <dx:ASPxGridView runat="server" AutoGenerateColumns="False"
                                    ID="gvForum"
                                    ClientInstanceName="gvForum" Width="100%"
                                    DataSourceID="odsForum"
                                    KeyFieldName="Id">
                                    <Styles>
                                ...
                                <asp:ObjectDataSource runat="server" ID="odsForum"
                                    ...
                                    <SelectParameters>
                                        ...
                                        <asp:Parameter Name="ArticleType" DefaultValue="Forum" />
                                    </SelectParameters>
