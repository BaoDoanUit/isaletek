<%@ Page Title="Events" Language="C#" MasterPageFile="~/Layout.master" AutoEventWireup="true" CodeBehind="Community_Events.aspx.cs" 
    Inherits="WebApplication.Pages.Community_Events" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="Content" runat="server">
    ...
    <div class="bx-events">
      ...
      <%--  <ul class="news-list-other">
            <li>
                <div style="margin: 0 auto; width: 200px; height:125px">
                    <img src="https://isalestek.com/UploadFiles/Events/Images/20191204_013552_xtvwj.png"" width="200" alt="" />
                </div>
            </li>
            <li>
                <div style="margin: 0 auto; width: 200px; height:125px">
                    <img src="https://isalestek.com/UploadFiles/Events/Images/20191203_021942_dlxmw.jpg" width="200" alt="" />
                </div>
            </li>
            <li>
                <div style="margin: 0 auto; width: 200px; height:125px">
